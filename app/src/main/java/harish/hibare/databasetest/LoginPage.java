...
public class LoginPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_username.setFilters(new InputFilter[]{new MainActivity.EmojiExcludeFilter()});
        edt_password.setFilters(new InputFilter[]{new MainActivity.EmojiExcludeFilter()});
    ...
    public void registeruser(View view) {
        Intent intent_reg = new Intent(getApplicationContext(),MainActivity.class);
